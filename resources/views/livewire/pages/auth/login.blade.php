...
<!-- Aquí va el formulario tradicional de login -->
<div>
    <!-- Botones de OAuth Social -->
    <div class="space-y-3 mb-6">
        <a href="{{ route('social.redirect', 'google') . (request()->query('intended') ? '?intended=' . urlencode(request()->query('intended')) : '') }}"
