<x-admin-layout>
    ...
    <div class="max-w-4xl">
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Editar Proyecto</h1>
        </div>
        ...
        <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <img src="{{ Storage::url($project->image) }}" alt="{{ $project->title }}" class="w-48 h-32 object-cover rounded-lg border border-gray-200 dark:border-gray-700">
                    </div>
                    @endif
            ...
            <div class="flex items-center justify-between">
                <button 
                    type="button"
                    onclick="if(confirm('¿Estás seguro de eliminar este proyecto?')) document.getElementById('deleteForm').submit()"
